...
def compute_throughout_metrics(
    batch: DataProto, timing_raw: dict[str, float], n_gpus: int, model_params_dict: dict[str, int] = None
) -> dict[str, Any]:
    """
    ...
    (tokens per second per GPU). Optionally computes per-sub-stage throughput and TFLOPs
    if model_params_dict is provided.
